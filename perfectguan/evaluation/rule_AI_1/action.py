...
class Action(object):
    ...
    def passive(self,actionList,handcards,rank,curAction,greaterAction,myPos,greaterPos,remaincards,
        ...
        restcards = rest_cards(handcards, remaincards, rank) # get union cards of others
    ...
    def rule_parse(self,msg,mypos,remaincards,history,pass_num,my_pass_num,tribute_result):
        self.action = msg["actionList"]
