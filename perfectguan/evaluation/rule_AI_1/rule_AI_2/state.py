...
class State(object):
    ...
    def notify_begin(self):
        ...
        """
        # TODO: 选手可自行做出其他处理
        Strategy0.SetBeginning(self._myPos, self._handCards)
        self._greaterPos = -1
        self._greaterAction = None
    ...
    def notify_play(self):
        ...
        """
        # TODO: 选手可自行做出其他处理
        Strategy0.UpdatePlay(self._curPos, self._curAction, self._greaterPos, self._greaterAction)
    ...
    def act_play(self):
        ...
        if (Strategy0.greaterPos == -1 or self._greaterPos==-1):
            Strategy0.UpdateCurRank(self._curRank)
